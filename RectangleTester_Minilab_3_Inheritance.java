...
public class RectangleTester_Minilab_3_Inheritance
{
	public static void main(String[ ] args)
	{
		...
		System.out.println("the sum of the dimensions is: " + myRect.getSumOfDimensions());
		...
		System.out.println("the sum of the dimensions is: " + anotherRect.getSumOfDimensions());
		...
		try
		{
			...
			System.out.println("the perimeter is: " + badRect1.getPerimeter());
			System.out.println("the width is: " + badRect1.getWidth());
		System.out.println("the sum of the dimensions is: " + badRect1.getSumOfDimensions());
		}
		catch(Throwable ex)
		{
		...
		try
		{
			...
			System.out.println("the sum of the dimensions is: " + badRect2.getSumOfDimensions());
		}
		catch(Throwable ex)
		{
			System.out.println(ex);    //just print the exception and keep going
